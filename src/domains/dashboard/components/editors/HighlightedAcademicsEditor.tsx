        ...
        >
            <div className="max-w-4xl mx-auto">
                {slots.map((item: any, index: number) => {
                    ...
                    return (
                        <div key={`slot-${item.key}-${index}`} className="group relative rounded-[48px] overflow-hidden bg-white border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-700 flex flex-col md:flex-row min-h-[450px]">
                            {/* Image Section */}
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left rounded-[40px] border-2 transition-all p-8 relative flex flex-col gap-4 group ${
                                                isAssigned 
                                                    ...
                                                    : "border-gray-50 hover:border-red-100 bg-white shadow-sm hover:shadow-xl"
                                            }`}
                                        >
